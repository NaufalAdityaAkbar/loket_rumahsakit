...
<div class="rounded-md border" :class="darkMode ? 'border-gray-700' : 'border-gray-300'">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <input 
                ...
                x-model="remember"
            >
            <label for="remember" class="text-sm cursor-pointer" :class="darkMode ? 'text-gray-300' : 'text-gray-700'">Ingat saya</label>
        </div>
    </div>
    ...
    <div class="relative my-4">
        ...
        <div class="relative flex justify-center text-sm">
            <span class="px-2" :class="darkMode ? 'bg-gray-800 text-gray-400' : 'bg-white text-gray-500'">Atau login dengan</span>
        </div>
    </div>
